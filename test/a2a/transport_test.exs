defmodule A2A.TransportTest do
  ...
  describe "available_transports/0" do
    test "always includes jsonrpc" do
      assert :jsonrpc in A2A.Transport.available_transports()
    end
    ...
    test "does not include grpc" do
      refute :grpc in A2A.Transport.available_transports()
    end
  end
  ...
  describe "available?/1" do
    ...
    test "unknown transports are not available" do
      ...
      refute A2A.Transport.available?(:grpc)
    end
  end
end
